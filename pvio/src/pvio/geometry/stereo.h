...
#include <pvio/utility/wahba_problem.h>
...
matrix<3> find_rotation_matrix(const std::vector<vector<3>> &points1, const std::vector<vector<3>> &points2, double threshold = 1.0, double confidence = 0.999, size_t max_iteration = 1000, int seed = 0);
...
matrix<3> find_rotation_matrix(const std::vector<vector<3>> &points1, const std::vector<vector<3>> &points2, std::vector<char> &inlier_mask, double threshold = 1.0, double confidence = 0.999, size_t max_iteration = 1000, int seed = 0);
